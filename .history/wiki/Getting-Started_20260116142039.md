...
FUXA UI will be available using the URL: http://localhost:1882.

Principally FUXA web server performs two page: 
- Visualization for end-user http://localhost:1882/home
- Editor to project and design http://localhost:1882/editor
